...
class TestComputeFlags(unittest.TestCase):
    """_compute_flags() should return True/False
    per stat vs average, or None if no average"""
...
class TestAlertsToDicts(unittest.TestCase):
    """_alerts_to_dicts() should convert raw alert
    flags into correctly structured dicts
    """
